## Problem 7: Joint and Marginal Densities
...
### Final Answer
- The **joint density** is: \( f(x, y) = \alpha \beta e^{-\alpha x} e^{-\beta y} \)
- The **marginal density of \( X \)** is: \( f_X(x) = \alpha e^{-\alpha x} \)
- The **marginal density of \( Y \)** is: \( f_Y(y) = \beta e^{-\beta y} \)
